...
public class PerfInvocationExpectationBuilder 
    implements ExpectationCapture, 
               ReceiverClause, MethodClause, ParametersClause
{
    private final PerfInvocationExpectation expectation = new PerfInvocationExpectation();
    ...
    public void addInSequenceOrderingConstraint(PerfSequence sequence) {
